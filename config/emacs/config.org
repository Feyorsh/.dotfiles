...
#+begin_src elisp
(use-package ox-hugo
    :mode ("content\\.org\\'" . org-mode)
    :init
    (setq org-hugo-external-file-extensions-allowed-for-copying '("txt" "jpg" "jpeg" "tiff" "png" "svg" "gif" "bmp" "mp4" "pdf" "odt" "doc" "ppt" "xls" "docx" "pptx" "xlsx"))
    :config
